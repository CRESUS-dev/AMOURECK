...
class Enterprise(TimeStampedModel):
    Name = models.CharField(max_length=255, blank=False, null=False, verbose_name="Dénomination")
    Address = models.CharField(max_length=255, blank=False, null=False, verbose_name="Addresse")
    Phone = models.CharField(max_length=20, verbose_name="N° Tél:")
    Head_office = models.CharField(max_length=255, blank=False, null=False, verbose_name="Siège social")
