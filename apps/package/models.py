...
class Package(TimeStampedModel):
    ...
    departure_town = models.ForeignKey(Town, verbose_name="Ville de départ", on_delete=models.CASCADE, blank=False, null=False, related_name='departure_town')
    arrival_town = models.ForeignKey(Town, verbose_name="Ville d'arrivé", on_delete=models.CASCADE, blank=False, null=False, related_name='arrival_town')
    receiver_name = models.CharField(verbose_name="Nom-Prénoms receveur", max_length=120, blank=False, null=False)
    receiver_phone =PhoneNumberField(verbose_name="Tél receveur", region="FR", unique=False, blank=True, null=True,default="")
    description = models.TextField(verbose_name="Description du colis", max_length=500, null=False, blank=False )
    package_count = models.PositiveIntegerField(verbose_name="Nombre de colis")
    price = MoneyField(verbose_name='Prix', max_digits=12, decimal_places=0,default=Money(0, 'XOF'))
